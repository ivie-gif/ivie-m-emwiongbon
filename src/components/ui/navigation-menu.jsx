...
const NavigationMenu = React.forwardRef(
  ...
  <NavigationMenuPrimitive.Root 
    ref={ref}
    className={cn("relative z-10 flex max-w-max flex-1 items-center justify-center", props.className)}
    {...props}
  >
    {props.children}
...
const NavigationMenuList = React.forwardRef(
  ...
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn("group flex flex-1 list-none items-center justify-center space-x-1", props.className)}
    {...props}
  />
));
